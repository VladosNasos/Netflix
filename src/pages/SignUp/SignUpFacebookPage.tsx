...
const SignUpFacebookPage: React.FC = () => {
  // In a real app, these might come from Facebook OAuth
  ...
  const handleContinue = () => {
    // Complete sign-up flow with Facebook
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* User email + Facebook icon side by side */}
        <Box
          sx={{
            display: 'flex',
            alignItems: 'center',
...
export default SignUpFacebookPage;
